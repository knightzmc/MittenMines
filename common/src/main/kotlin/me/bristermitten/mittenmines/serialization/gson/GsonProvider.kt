...
class GsonProvider @Inject constructor(private val typeAdapterFactories: Set<TypeAdapterFactory>) : Provider<Gson> {
    override fun get(): Gson {
        return GsonBuilder()
            ...
            .also { builder -> typeAdapterFactories.forEach(builder::registerTypeAdapterFactory) }
            .create()
    }
}
